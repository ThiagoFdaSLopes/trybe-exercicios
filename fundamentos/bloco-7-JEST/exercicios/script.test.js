...
describe('Testando se a função SearchEmploye existe', () => {
  it('Testa se a função hydrate é definida', () => {
...
describe('Testando o funcionamento da função SearchEmployee', () => {
  it('Testando o ID e Detail não informado', () => {
    expect(searchEmployee('','firstname')).toBe('ID não identificada');
    expect(searchEmployee('5569-4', '')).toBe('Informação não identificada');
  });
  it()
